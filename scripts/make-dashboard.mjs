#!/usr/bin/env node
/**
 * Generate self-contained CodeCortexLoop HTML dashboard
 *
 * Usage:
 *   node scripts/make-dashboard.mjs [report.json] [--history=.cortexloop/history.json] [--out=docs/cortexloop/report.html]
 */
...
<title>CodeCortexLoop Report — ${escapeHtml(String(Math.round(overall ?? 0)))}</title>
<style>
...
<div class="wrap">
  <header>
    ...
    <div style="text-align:right">
      <div class="meta">Generated by CodeCortexLoop v2.2</div>
    </div>
  </header>
  ...
  <footer>CodeCortexLoop — one-command post-coding pipeline · MIT</footer>
</div>
</body>
</html>`;
...
console.log(`[cortexloop] Dashboard -> ${outPath}`);
